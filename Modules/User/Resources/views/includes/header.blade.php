                        ...
                        <div class="d-flex ms-auto">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex">
                                                    <div class="ps-3">
                                                        ...
                                                        <p class="fs-13 mb-1">Just created a new blog
                                                            post</p>
                                                        <div class="small text-muted">
                                                            45 mintues ago
                                                        </div>
                            ...
                            <div class="dropdown profile-dropdown">
                                ...
                                <div
                                    ...
                                    <a class="dropdown-item d-flex" href="{{url('admin/subscription/renew')}}">
                                        <i class="feather feather-bookmark me-3 fs-16 my-auto"></i>
                                        <div class="mt-1">Subscription <span class="bradius bg-danger-transparent">{{tenant('rest_days_in_subscription')}} days</span>
                                        </div>
                                    </a>
                                    @endcan
